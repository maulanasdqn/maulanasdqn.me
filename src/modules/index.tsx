      ...
      <MainLayout>
        <ContentLayout>
          <section className="flex flex-col items-start justify-start w-full h-full py-6">
            <div className="flex flex-col md:flex-row transition-all transform ease-in-out delay-500 gap-x-6 items-center h-auto">
              <h1 className="text-6xl lg:text-9xl text-black-900 font-sans">
                Hi iam
              </h1>
              <span className="flex text-3xl lg:hidden">Frontend Developer</span>
